...
public class CapNhatDonThuocMauController implements Initializable{
		@FXML
...
//		        NhanVienController nv = loader.getController();
		...
		public void ctCapNhatThuoc(ActionEvent e) throws IOException {
			Stage stage = new Stage();
			FXMLLoader loader = new FXMLLoader();
	        loader.setLocation(getClass().getResource("/view/CTCapNhatThuoc.fxml"));
	        Parent sampleParent = loader.load();
	        Scene scene = new Scene(sampleParent);
	        stage.setScene(scene);
	        stage.show();
